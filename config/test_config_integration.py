...
class TestDynamicConfigBasic:
    ...
    def test_load_defaults(self, tmp_path):
        ...
        config = DynamicConfig(TEST_STRUCTURE, config_file=str(config_file), enable_env_vars=False)
...
class TestDynamicConfigUIInteraction:
    ...
    def test_set_value_without_env_override(self, tmp_path):
        ...
        config2 = DynamicConfig(TEST_STRUCTURE, config_file=str(config_file), enable_env_vars=False)
